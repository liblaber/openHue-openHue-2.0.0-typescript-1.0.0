 ...
 * Is equal to application shape if all property names match the api schema
 */
export const lightGetDynamicsRequest = z
  .object({
    status: supportedDynamicStatus.nullish(),
    statusValues: z.array(supportedDynamicStatus).nullish(),
    speed: z.number().nullish(),
    speedValid: z.boolean().nullish(),
  })
  .transform((data) => ({
    status: data['status'],
