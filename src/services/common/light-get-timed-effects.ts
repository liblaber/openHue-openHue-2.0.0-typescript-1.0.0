 ...
 * Is equal to application shape if all property names match the api schema
 */
export const lightGetTimedEffectsRequest = z
  .object({
    effect: supportedTimedEffects.nullish(),
    effectValues: z.array(supportedTimedEffects).nullish(),
    status: supportedTimedEffects.nullish(),
    statusValues: z.array(supportedTimedEffects).nullish(),
