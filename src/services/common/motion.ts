...
import { z } from 'zod';
import { motionReport, motionReportRequest, motionReportResponse } from './motion-report';
...
export const motionResponse = z
  .object({
    ...
    motion_report: motionReportResponse.optional(),
  })
  .transform((data) => ({
    motion1: data['motion'],
...
export const motionRequest = z
  .object({
    motion1: z.boolean().nullish(),
    motionValid: z.boolean().nullish(),
    motionReport: motionReportRequest.nullish(),
  })
  .transform((data) => ({
    motion: data['motion1'],
