...
export const temperaturePut = z.object({
  type_: temperaturePutType.optional(),
 ...
 */
export const temperaturePutResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const temperaturePutRequest = z
  .object({ type_: temperaturePutType.nullish(), enabled: z.boolean().nullish() })
  .transform((data) => ({
    type: data['type_'],
    enabled: data['enabled'],
  }));
