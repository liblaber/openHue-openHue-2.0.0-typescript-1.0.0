...
import {
  ...
  getTemperatureOkResponseResponse,
  getTemperaturesOkResponseResponse,
  temperaturePutRequest,
  updateTemperatureOkResponseResponse,
} from './models';
...
export class TemperatureService extends BaseService {
   ...
   */
  async getTemperatures(requestConfig?: RequestConfig): Promise<HttpResponse<GetTemperaturesOkResponse>> {
    const path = '/clip/v2/resource/temperature';
    const options: any = {
      responseSchema: getTemperaturesOkResponseResponse,
      requestSchema: z.any(),
      headers: {},
  ...
  async getTemperature(
    ...
    const options: any = {
      responseSchema: getTemperatureOkResponseResponse,
      requestSchema: z.any(),
      headers: {},
      requestContentType: ContentType.Json,
      responseContentType: ContentType.Json,
  ...
  async updateTemperature(
    ...
    const options: any = {
      responseSchema: updateTemperatureOkResponseResponse,
