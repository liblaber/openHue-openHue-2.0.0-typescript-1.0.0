...
import { resourceGet, resourceGetRequest, resourceGetResponse } from './resource-get';
 ...
 */
export const getResourcesOkResponseResponse = z
  .object({
    errors: z.array(errorResponse).optional(),
    data: z.array(resourceGetResponse).optional(),
  })
  .transform((data) => ({
    errors: data['errors'],
    data: data['data'],
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const getResourcesOkResponseRequest = z
  .object({ errors: z.array(errorRequest).nullish(), data: z.array(resourceGetRequest).nullish() })
  .transform((data) => ({
    errors: data['errors'],
    data: data['data'],
  }));
